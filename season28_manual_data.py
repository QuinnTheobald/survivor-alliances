"""
Survivor Season 28: Cagayan (2014)

Pre-merge voting data for alliance analysis.
Merge Episode: 6 (only Episodes 1-5 are included here)

Data Source: https://survivor.fandom.com/wiki/Survivor:Cagayan
"""
...
# Pre-merge tribal councils only (Episodes 1-5)
# Stop BEFORE Episode 6 (merge episode)
